...
namespace Advent_of_Code_2021.Day_3
{
    public class Rates
    {
        ...
        public void SortMostLeast()
        {
            leatlist = binStrings;
            //var incomingNumber = sr.ReadLine().ToCharArray();
            for (int i = 0; i < 12; i++)
            {
        ...
        public void CalculateRates()
        {
            ...
            foreach (var item in binStrings)
            {
                Console.WriteLine("most" + item);
            }
            foreach (var item in leatlist)
            {
                Console.WriteLine("least" + item);
            }
            ...
            //Console.WriteLine("Power comsmption: " + (gamma * epsilon));
        }
    }
}
